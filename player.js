...
class Player {
    constructor(el, app){
        ...
        this.no = this.playerDom.querySelector(".no");
        this.one = this.playerDom.querySelector(".one");
        this.list = this.playerDom.querySelector(".list");
